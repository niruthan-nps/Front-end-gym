...
//   sets: number;
//   weight: number;
//   createdAt: Date; // ✅ Now Date object
// }
...
//         sets: item.sets || 0,
//         weight: item.weight || 0,
//         createdAt: item.createdAt ? new Date(item.createdAt.$date) : new Date(), // ✅ Proper Date mapping
//       }));
...
//                 {workout.description && <p className="text-sm text-gray-600 mt-2">{workout.description}</p>}
